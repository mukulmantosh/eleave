...
if($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	{
		header('Location:hodleavehistory.php');
		die();
	}
...
<div class="box">
<div class="box-title">
<h3><i class="fa fa-table"></i>HOD's Pending Leaves</h3>
<div class="box-tool">
...
$sql= $leaveCollection->find(array("emptype" => 'hod', 'leavestatus' =>'Forwarded to Director'));
...
<center><input type="submit" name="forwardleave" class="btn btn-primary btn-sm" value="ACCEPT LEAVE APPLICATION OF HOD"></center>

<br>
<center><input type="submit" name="rejectleave" class="btn btn-danger btn-sm" value="REJECT LEAVE APPLICATION OF HOD"></center>
